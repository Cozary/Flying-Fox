...
public class ModSpawnEggs {
    ...
    public static final Supplier<Item> FLYING_FOX_EGG = registerWithTab("flying_fox_spawn_egg", () -> new SpawnEggItem(ModEntityTypes.FLYING_FOX.get(), 0xb6812f, 0xace2ea, new Item.Properties()));
